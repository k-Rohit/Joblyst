...
Five fictional personas, all in English, committed to the repo so the eval
batch needs no setup and no real person's data.
...
They differ on two axes on purpose:
  ...
  junior_ds_us       ALL-CAPS headings, comma-separated skills, "-" bullets
  senior_mle_uk      Title Case headings, "Category: a, b" skill lines
  ...
  lead_de_remote     "TECH STACK" heading, long bullets that wrap across lines
  mid_analyst_us     no summary at all, education before experience, one skill
                     per line
...
def junior_ds_us() -> None:
    _render(
        "Maya Chen",
        "San Francisco, CA, USA  |  maya.chen@example.com  |  +1 415 555 0142  |  Open to hybrid",
        [
            ("SUMMARY", [
            ...
            ("EXPERIENCE", [
                "Junior Data Scientist, Northwind Analytics, San Francisco (2024 - Present)",
                ...
                "Data Science Intern, Northwind Analytics, San Francisco (2023 - 2024)",
                ...
                "Undergraduate Research Assistant, UC Davis Statistics Department (2022 - 2023)",
            ...
            ("EDUCATION", [
                "BS Statistics, University of California Davis (2023)",
...
def senior_mle_uk() -> None:
    _render(
        "Daniel Osei",
        "London, United Kingdom  |  daniel.osei@example.com  |  +44 20 7946 0871",
        [
            ...
            ("Work Experience", [
                "Senior Machine Learning Engineer, Halcyon Data, London (2021 - Present)",
                ...
                "Machine Learning Engineer, Brightlane, London (2018 - 2021)",
                ...
                "Data Scientist, Meridian Retail Group, Manchester (2017 - 2018)",
            ...
            ("Selected Talks and Publications", [
                "Serving Recommendations at Low Latency - PyData London (2023)",
            ...
            ("Education", [
                "MSc Computer Science, Imperial College London (2017), Distinction",
                "BSc Mathematics, University of Manchester (2015), First Class Honours",
            ]),
            ("Certifications", [
...
def lead_de_remote() -> None:
    _render(
        "Sofia Almeida",
        "Berlin, Germany  |  sofia.almeida@example.com  |  Open to remote only",
        [
            ("PROFILE", [
                ...
                "Works remotely by preference and has led fully distributed teams across four time zones.",
            ]),
            ("TECH STACK", [
            ...
            ("EXPERIENCE", [
                "Lead Data Engineer, Kestrel Systems, Berlin (2020 - Present)",
                ...
                "- Led a team of 6 engineers distributed across Berlin, Lisbon and Bangalore, running "
                ...
                "Senior Data Engineer, Alpenroute GmbH, Munich (2016 - 2020)",
                ...
                "Data Engineer, Nordwind Logistics, Hamburg (2014 - 2016)",
            ...
            ("LEADERSHIP AND COMMUNITY", [
                "Organiser, Berlin Data Engineering meetup (2019 - Present)",
                "Speaker, Data Council Europe: Streaming Without the Tears (2023)",
                "Mentor, Women in Data Berlin mentorship programme (2021 - Present)",
            ]),
            ("EDUCATION", [
                "Diplom Informatik, TU Berlin (2012)",
            ]),
        ],
        "lead_de_remote.pdf",
    )
...
def mid_analyst_us() -> None:
    _render(
        "Ryan Patel",
        "Austin, TX, USA  |  ryan.patel@example.com  |  +1 512 555 0193",
        [
            ("EDUCATION", [
                "BA Economics, University of Texas at Austin (2021)",
                "Minor in Statistics. Dean's List 2019, 2020.",
            ]),
            ("SKILLS", [
                "SQL",
                "Excel",
            ...
            ("EXPERIENCE", [
                "Data Analyst, Cedarpoint Retail, Austin (2022 - Present)",
                ...
                "1.4M dollars of margin in one season.",
                ...
                "Business Analyst, Cedarpoint Retail, Austin (2021 - 2022)",
                ...
                "roughly 200,000 dollars of incorrect reorders.",
                "- Supported the annual budgeting cycle with historical trend analysis.",
                "Analytics Intern, Lone Star Insurance, Austin (2020 - 2021)",
